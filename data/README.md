...
python -m src solve data/processed/kris_small/instances_100_1.json --method ALNS --seconds 3 --output results/kris_solution.json
python -m src validate data/processed/kris_small/instances_100_1.json results/kris_solution.json
